...
const zooPop = (accumulator, currentPop) => accumulator + currentPop;
let zooPopArray = [];
zooAnimals.forEach(animal => zooPopArray.push(animal.population))
populationTotal = zooPopArray.reduce(zooPop)
